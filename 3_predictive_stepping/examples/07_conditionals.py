...
Conditional statements execute different lines of code depending on the value of an expression
...
# -- if/elif/else statements conditionally execute blocks of code based on multiple expressions --
#      the else block is the code to execute by default if no expression if no condition is met
